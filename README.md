...
[Releases](https://github.com/tsukadam/comic_viewer_tune/releases) から最新版を落としてください。一番上のcomic_viewer_tune_日付.zip が配布用の一式です。
...
1. **content** 以下に任意の名前のフォルダを作り、連番画像（1.png, 2.png, …）を置く
2. **content/sample**内の**index.html** をコピーして、連番画像と同階層に置く
3. **index.html**の冒頭を編集して作品情報を入力する
4. アップして**index.html**にアクセスするとビューアー表示されます
